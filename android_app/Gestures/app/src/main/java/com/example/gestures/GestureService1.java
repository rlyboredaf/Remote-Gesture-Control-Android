...
public class GestureService1 extends AccessibilityService {
    //Class variables
    ...
    public void perform_gesture(DataSnapshot gesture_snapshot) {
        ...
        Point center = new Point((int)(anchor_pos_x * width), (int)(anchor_pos_y * height));

        Point pu = new Point(center.x, Math.max(center.y - v_deviation, 0));                //Upper point
        Point pd = new Point(center.x, Math.min(center.y + v_deviation, (int)height));      //Lower point
        Point pl = new Point(Math.max(center.x - h_deviation, 0), center.y);                //Left point
        Point pr = new Point(Math.min(center.x + h_deviation, (int)width), center.y);       //Right point
        //------------------------------------------------------------------------------------------------------------------
